...
This post describes one version of a technique I call "Red Penning", a technique for solving a problem when it feels like there is no solution.  It is designed to use external working memory aids to cycle through focussed sessions of 
